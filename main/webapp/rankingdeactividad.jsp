...
<%@ page import="interfaces.ICrankingdeactividades"%>
		...
		<div class="leaderboard">
  			...
  			<ol class="ol">
				<%Fabrica f = Fabrica.getInstancia();
			 	  ICrankingdeactividades ICra = f.getICrankingdeactividades();
				  ArrayList<DtActividadDep> actividades = ICra.RankActividadesDT();
			 	  ArrayList<Integer> cant = ICra.obtCantClases();
				  int i=0;
