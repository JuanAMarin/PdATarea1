...
<%@ page import="interfaces.ICrankingdeclases"%>
		...
		<div class="leaderboard">
  			...
  			<ol class="ol">
				<%Fabrica f = Fabrica.getInstancia();
				  ICrankingdeclases ICrc = f.getICrankingdeclases();
				  ArrayList<DtClase> clases = ICrc.obtRankClasesDT();
				  ArrayList<Integer> cant = ICrc.obtCantRegistros();
				  int i=0;
