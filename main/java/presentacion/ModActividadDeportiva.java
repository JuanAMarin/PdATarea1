...
import interfaces.ICmodactividaddeportiva;
...
public class ModActividadDeportiva extends JInternalFrame {
	...
	public ModActividadDeportiva(ICmodactividaddeportiva ICmad) {
		ICMad = ICmad; 
		setClosable(true);
	...
	protected void AceptarActionPerformed(ActionEvent arg0) {
		...
		if(checkFormulario()) {
			...
			JOptionPane.showMessageDialog(this, "La Actividad Deportiva "+nombre+" se ha modificado con éxito", "Modificar Actividad Deportiva",
